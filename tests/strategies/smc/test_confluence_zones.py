...
class TestConfluenceZoneAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analyzer = ConfluenceZoneAnalyzer(
            market_structure=self.market_structure, timeframe="1h"
        )
    ...
    def test_find_confluence_at_price(self):
        ...
        # Add some test zones
        ob = OrderBlock(
            is_bullish=True, high=Decimal("105"), low=Decimal("100"), status=ZoneStatus.ACTIVE
        )
        self.analyzer.order_blocks.append(ob)
    ...
    def test_cleanup_zones(self):
        ...
        active_ob = OrderBlock(
            is_bullish=True, high=Decimal("110"), low=Decimal("105"), status=ZoneStatus.ACTIVE
        )
    ...
    def test_performance(self):
        ...
        self.assertLess(
            elapsed_time, 2000, f"Analysis took {elapsed_time:.2f}ms, should be < 2000ms"
        )
...
class TestFairValueGap(unittest.TestCase):
    ...
    def test_fvg_gap_size(self):
        ...
        fvg = FairValueGap(gap_high=Decimal("110"), gap_low=Decimal("100"))
...
class TestLiquidityZone(unittest.TestCase):
    ...
    def test_get_active_liquidity_zones(self):
        ...
        # Add zones
        analyzer.liquidity_zones.append(
            LiquidityZone(
                is_bullish=True,
                level=Decimal("110"),
                swept=False,
